...
│   ├── README_GifCreation.txt   # How to make GIFs without losing your mind
│   └── README_processImageLogo.txt  # Logo processing and image tricks
│
...
The crown jewel of this repository! This directory contains scripts for:

- **GIF Creation**: Turn a bunch of images into smooth, beautiful animated GIFs. Perfect for memes, tutorials, or making your cat look like it's dancing.
- **Image Processing**: Batch operations, logo manipulation, and other pixel-pushing magic.
...
chmod +x Image_Manipulation/*.bash
